...
export class controleApiMigrations1643279835933 implements MigrationInterface {
    name = 'controleApiMigrations1643279835933'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "celulares" ADD CONSTRAINT "FK_0d3e774bd8871f947b2a6711f94" FOREIGN KEY ("imeisId") REFERENCES "imeis"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
